                                ...
                                <div class="mb-0">
                                    ...
                                    <div class="row gx-10 mb-5">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <!--begin::Input group-->
                                            <div class="mb-5">
                                                <input type="text" name="company_email" class="form-control form-control-solid" placeholder="{{ __('Email') }}" value="{{ isset($quotation) ? $quotation->company_email : \Illuminate\Support\Facades\Auth::user()->currentTeam->email }}" />
                                            </div>
                                            <!--end::Input group-->
                                            <!--begin::Input group-->
                                            <div class="mb-5">
                                                <textarea name="company_address" class="form-control form-control-solid" rows="3" placeholder="{{ __('Address') }}" >{{ isset($quotation) ? $quotation->company_address : \Illuminate\Support\Facades\Auth::user()->currentTeam->address }}</textarea>
                                            </div>
                                            <!--end::Input group-->
                                        </div>
                                        <!--end::Col-->
                                    ...
                                    <div class="table-responsive mb-10">
                                        ...
                                        <table class="table g-5 gs-0 mb-0 fw-bold text-gray-700" data-kt-element="items">
                                            ...
                                            <tr class="border-bottom fs-7 fw-bold text-gray-700 text-uppercase">
                                                ...
                                                <th class="min-w-100px w-100px">{{ __('Qty') }}</th>
                                            ...
                                            <tbody>
                                                ...
                                                <td class="pe-7">
                                                    <input type="text" class="form-control form-control-solid" name="description[]" placeholder="{{ __('Description') }}" value="{{ $item->description }}" />
                                                </td>
                                                <td class="ps-0">
                                                ...
                                                <tr class="border-bottom border-bottom-dashed" data-kt-element="item">
                                                    <td class="pe-7">
                                                        <input type="text" class="form-control form-control-solid" name="description[]" placeholder="{{ __('Description') }}" />
                                                    </td>
                                                    <td class="ps-0">
                                            ...
                                            <tfoot>
                                                ...
                                                <th class="text-primary">
                                                    <button class="btn btn-sm btn-primary" data-kt-element="add-item">{{ __('Add item') }}</button>
                                                </th>
                                            ...
                                            <tfoot>
                                                <tr class="border-top border-top-dashed align-top fs-6 fw-bold text-gray-700">
                                                    ...
                                                    <th colspan="2" class="border-bottom border-bottom-dashed ps-0">
                                                        <div class="d-flex flex-column align-items-start">
                                                            <div class="fs-5">Subtotal</div>
                                                            <div class="fs-5 tax_label">{{ __('VAT') }}</div>
