                    ...
                    <div class="d-flex flex-column flex-xl-row">
                        ...
                        <div class="flex-lg-row-fluid me-xl-18 mb-10 mb-xl-0">
                            ...
                            <div class="mt-n1">
                                ...
                                <div class="d-flex flex-stack pb-10">
                                    ...
                                    <!--end::Logo-->
                                    <!--begin::Action-->
                                    <a href="#" class="btn btn-sm btn-success d-none">{{ __('Pay Now') }}</a>
                                    <!--end::Action-->
                                </div>
                                <!--end::Top-->
                                <!--begin::Wrapper-->
                                <div class="m-0">
                                    <!--begin::Label-->
                                    <div class="fw-bold fs-3 text-gray-800 mb-8">{{ __('Quotation') }} #{{ $quotation->number ?? \App\Enums\EnumQuotationStatus::DRAFT->value }}</div>
                                    <!--end::Label-->
                                    <!--begin::Row-->
                                    <div class="row g-5 mb-11">
                                        ...
                                        <div class="col-sm-6">
                                            <!--end::Label-->
                                            <div class="fw-semibold fs-7 text-gray-600 mb-1">{{ __('Issue date:') }}</div>
                                            <!--end::Label-->
                                            <!--end::Col-->
                                            ...
                                            <div class="fw-bold fs-6 text-gray-800 d-flex align-items-center flex-wrap">
                                                ...
                                                @if ($quotation->due_date)
                                                    ...
                                                    @elseif ($daysUntilDue > 0)
                                                        <span class="fs-7 text-danger d-flex align-items-center">
                                                            <span class="bullet bullet-dot bg-danger me-2"></span>
                                                            {{ __('Due in') }} {{ $daysUntilDue }} {{ $daysUntilDue === 1 ? __('day') : __('days') }}
                                                        </span>
                                                    @endif
                                                @endif
                                            </div>
                                            ...
                                            <table class="table mb-3">
                                                <thead>
                                                    <tr class="border-bottom fs-6 fw-bold text-muted">
                                                        <th class="min-w-70px text-end pb-2">{{ __('Qty') }}</th>
                        ...
                        <div class="m-0">
                            ...
                            <div class="d-print-none border border-dashed border-gray-300 card-rounded h-lg-80 min-w-md-350px p-9 bg-lighten">
                                <!--begin::Labels-->
                                <div class="mb-8">
                                    <span class="d-none badge badge-light-success me-2">{{ __('Approved') }}</span>
                                    <span class="d-none badge badge-light-warning">{{ __('Pending Payment') }}</span>
                                ...
                                <!--begin::Item-->
                                <div class="mb-15">
                                    <div class="fw-semibold text-gray-600 fs-7">{{ __('Payment Term:') }}</div>
